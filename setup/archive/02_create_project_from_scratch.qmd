...
## 2. Create a Virtual Environment for your project in VSC
...
5.  Other options to run this file:
    ...
    b.  You can also run the script by selecting the **Play icon button** at the top of the editor window where you have `greeting.py`. Note: with this method, you are NOT using uv to run the script. Therefore, VSC may not know which Python version on your computer to run or it may choose a version that doesn't work. If you get an error:
         choose the version that looks something like this: `Python 3.XX.X (sample-project) .\.venv\Scripts\python.exe              Workspace`.
