...
10. Write code (see Step 4 above for an example script) and save your script.

11. Run your script with `uv run code/script-name.py` or by pressing the "Play" button.

12. To run code requiring external packages:
...
13. To create a Jupyter notebook:
